  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <p style={{ position: "absolute", top: "20px", fontSize: "14px" }} className={styles.click}>
        ...
        <p className={styles.desc}>
          We, at Miraki Tech, serve to facilitate businesses to grow mutually
          higher with customers. We focus on three core factors: your web site,
          apps, brand, promotion. We understand the means of establishing
          websites and mobile applications via our expertise and deliver
          award-winning solutions. What makes us stand out from the crowd? We
          possess technologically advanced IT solutions given by creative and
